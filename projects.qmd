...
<main class="projects-page">
  ...
  <section class="featured-projects featured-projects-random" aria-label="Featured projects">
    <a class="featured-project compact is-active is-large" href="posts/machine_learning_projects/Longetivity_dataviz.html" data-featured-card data-featured-pin>
      ...
      <div class="featured-copy">
        ...
        <p>Interactive visual story on regional, economic, social, and health drivers of global longevity.</p>
      </div>
    </a>
  ...
  <section class="project-archive" aria-label="All projects">
    ...
    <div class="project-grid">
      <a class="archive-card" href="posts/machine_learning_projects/Longetivity_dataviz.html">
        <div class="archive-card-top">
          <span class="archive-type">Data Visualization</span>
          <span class="archive-year">2024</span>
        </div>
        <h3>Data Visualization: A Global Journey Through Life Expectancy</h3>
        <p>Interactive visual analysis of regional, temporal, social, economic, and health factors shaping global life expectancy.</p>
...
<script>
  document.addEventListener('DOMContentLoaded', function(){
    ...
    var pinnedCard = document.querySelector('[data-featured-pin]');
    var rotatingCards = pinnedCard ? cards.filter(function(card){
      return card !== pinnedCard;
    }) : cards;
    ...
    for (var i = rotatingCards.length - 1; i > 0; i--) {
      var j = Math.floor(Math.random() * (i + 1));
      var temp = rotatingCards[i];
      rotatingCards[i] = rotatingCards[j];
      rotatingCards[j] = temp;
    }

    var selectedCards = pinnedCard ? [pinnedCard].concat(rotatingCards.slice(0, 2)) : rotatingCards.slice(0, 3);
